...
# Generated by Powerlevel10k configuration wizard on 2023-07-11 at 14:39 EDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 42056.
# Wizard options: compatible, rainbow, ascii, 24h time, 2 lines, solid,
...
() {
  ...
  function my_git_formatter() {
    ...
    # Use %7F for white, %0F for black, %1F for red
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=53
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=237
